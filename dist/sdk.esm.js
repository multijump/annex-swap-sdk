...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = '0x6100af6980d35FDb119BECE4969fF6b68DA6e4ea', _FACTORY_ADDRESS[ChainId.BSCTESTNET] = '0xd81014579288221814b5E066AaCF0B4A00739a24', _FACTORY_ADDRESS[ChainId.CASSINI] = '0x43c369A3Fea13002e11059855Dc57F3Fe9dA81B7', _FACTORY_ADDRESS[ChainId.CRONOS] = '0x1cc79ECb3a6f9B6d6FaF7298ec6D8667E814d592', _FACTORY_ADDRESS[ChainId.KAVA] = '0x1cc79ECb3a6f9B6d6FaF7298ec6D8667E814d592', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = '0x748c3338a3ac4246245619282e4a44ddbf8d64c31fff15f3fcc0596b76669465', _INIT_CODE_HASH[ChainId.BSCTESTNET] = '0x163dd3668bfee3af10fd857a489c4dd9929f2f02440670f54d71ed57c025f4e8', _INIT_CODE_HASH[ChainId.CASSINI] = '0x370859e0d12eaf24013515aa62dab3edc3947ceb62f71fecb341cc6a123fceb8', _INIT_CODE_HASH[ChainId.CRONOS] = '0x748c3338a3ac4246245619282e4a44ddbf8d64c31fff15f3fcc0596b76669465', _INIT_CODE_HASH[ChainId.KAVA] = '0x748c3338a3ac4246245619282e4a44ddbf8d64c31fff15f3fcc0596b76669465', _INIT_CODE_HASH);
...
var ETHERS = (_ETHERS = {}, _ETHERS[ChainId.MAINNET] = Currency.ETHER, _ETHERS[ChainId.BSCTESTNET] = Currency.TBNB, _ETHERS[ChainId.CASSINI] = Currency.TCRO, _ETHERS[ChainId.CRONOS] = Currency.CRO, _ETHERS[ChainId.KAVA] = Currency.KAVA, _ETHERS);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === ETHERS[pairs[0].chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === ETHERS[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHERS[route.chainId] ? CurrencyAmount.ether(amounts[0].raw, route.chainId) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHERS[route.chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.chainId) : amounts[amounts.length - 1];
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, AnnexAbi.abi, provider).getReserves()).then(function (_ref) {
