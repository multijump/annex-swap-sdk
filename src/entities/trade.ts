...
export class Trade {
  ...
  public constructor(route: Route, amount: CurrencyAmount, tradeType: TradeType) {
    ...
    this.inputAmount =
      tradeType === TradeType.EXACT_INPUT
        ? amount
        : route.input === ETHERS[route.chainId]
        ? CurrencyAmount.ether(amounts[0].raw, route.chainId)
        : amounts[0]
    this.outputAmount =
      tradeType === TradeType.EXACT_OUTPUT
        ? amount
        : route.output === ETHERS[route.chainId]
   ...
   */
  public minimumAmountOut(slippageTolerance: Percent, chainId: ChainId = ChainId.MAINNET): CurrencyAmount {
   ...
   * @param slippageTolerance tolerance of unfavorable slippage from the execution price of this trade
   */
  public maximumAmountIn(slippageTolerance: Percent, chainId: ChainId = ChainId.MAINNET): CurrencyAmount {
    invariant(!slippageTolerance.lessThan(ZERO), 'SLIPPAGE_TOLERANCE')
